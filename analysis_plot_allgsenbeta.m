function beta_est = analysis_plot_allgsenbeta(sdata,nb_timeslots)
    ...
    beta_est    = nan(nb_subjects,nb_timeslots,2);
    for i_subject = 1:nb_subjects
        ...
        for i_timeslot = 1:nb_timeslots
            ...
            % get corbetas
            beta_est(i_subject,i_timeslot,:) = analysis_plot_enbeta(data);
        end
    end
